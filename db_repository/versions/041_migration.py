...
def upgrade(migrate_engine):
    ...
    post_meta.tables['camp_contact_block'].columns['en_right_subheader'].create()
    post_meta.tables['camp_contact_block'].columns['es_right_subheader'].create()
    post_meta.tables['camp_contact_block'].columns['fr_right_subheader'].create()
    post_meta.tables['camp_contact_block'].columns['ru_right_subheader'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['camp_contact_block'].columns['en_right_subheader'].drop()
    post_meta.tables['camp_contact_block'].columns['es_right_subheader'].drop()
    post_meta.tables['camp_contact_block'].columns['fr_right_subheader'].drop()
    post_meta.tables['camp_contact_block'].columns['ru_right_subheader'].drop()
