...
def upgrade(migrate_engine):
    ...
    post_meta.tables['camp_main_info_block'].columns['en_hidden_text'].create()
    post_meta.tables['camp_main_info_block'].columns['es_hidden_text'].create()
    post_meta.tables['camp_main_info_block'].columns['fr_hidden_text'].create()
    post_meta.tables['camp_main_info_block'].columns['ru_hidden_text'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['camp_main_info_block'].columns['en_hidden_text'].drop()
    post_meta.tables['camp_main_info_block'].columns['es_hidden_text'].drop()
    post_meta.tables['camp_main_info_block'].columns['fr_hidden_text'].drop()
    post_meta.tables['camp_main_info_block'].columns['ru_hidden_text'].drop()
