...
def upgrade(migrate_engine):
    ...
    post_meta.tables['camp_contact_useful_page'].columns['en_link'].create()
    post_meta.tables['camp_contact_useful_page'].columns['ru_link'].create()
    post_meta.tables['camp_contact_useful_page'].columns['fr_link'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['camp_contact_useful_page'].columns['en_link'].drop()
    post_meta.tables['camp_contact_useful_page'].columns['ru_link'].drop()
    post_meta.tables['camp_contact_useful_page'].columns['fr_link'].drop()
