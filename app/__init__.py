...
admin.add_view(ModelView(models.CampHtguPage, db.session))
admin.add_view(ModelView(models.CampHtguRoute, db.session))
admin.add_view(ModelView(models.CampInsurancePage, db.session))
